...
function TechnicalHealthLayout() {
  ...
  const isCwvRoute = location.pathname.includes("/technical-health/cwv");
  const title = location.pathname.endsWith("/technical-health/cwv/deep-dive")
    ? "Page Type Deep Dive"
    : location.pathname.endsWith("/technical-health/cwv/opportunities")
      ? "Opportunities Table"
      : location.pathname.endsWith("/technical-health/cwv")
        ? "CWV Impact Overview"
        : "Technical Health";
