...
export const Route = createFileRoute("/audit-runs_/$runId_/urls")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Explore, search, and filter every URL discovered in an OrganicOS audit crawl.",
      },
...
const AUDIT_RUNS: AuditRun[] = [
  ...
  {
    id: "migration",
    name: "Post-Migration Guardrail",
    lastRun: "Apr 23 · 01:04",
    urlsCrawled: 94512,
  },
  {
    id: "marketplace",
    name: "Marketplace Supply Pages",
    lastRun: "Apr 22 · 13:30",
    urlsCrawled: 27650,
  },
...
const URL_ROWS: CrawlUrl[] = [
  {
    ...
    title: "Busbud: Book Bus & Train Tickets",
    pageType: "Commerce",
    status: 200,
    indexable: "Yes",
    depth: 0,
    inlinks: 7364,
    organicTraffic: 13110,
    impressions: 1147712,
    segment: "All",
    issue: "None",
    firstFound: "C-12",
  ...
  {
    id: "u2",
    url: "https://www.busbud.com/en/country/us",
    title: "Bus, Train, and Shuttle in United States",
    pageType: "City",
    status: 200,
    indexable: "Yes",
    depth: 1,
  ...
  {
    id: "u4",
    url: "https://www.busbud.com/en/bus-tickets/new-york-boston",
  ...
  {
    id: "u5",
    url: "https://www.busbud.com/en/train/london-manchester",
    title: "London to Manchester Train Tickets",
    pageType: "Route",
    status: 200,
    indexable: "Yes",
    depth: 2,
  ...
  {
    id: "u6",
    url: "https://www.busbud.com/en/operator/flixbus",
    title: "FlixBus Tickets and Schedules",
    pageType: "Operator",
    status: 301,
    indexable: "No",
    depth: 3,
  ...
  {
    id: "u7",
    url: "https://www.busbud.com/en/city/rome",
    title: "Buses to Rome",
    pageType: "City",
    status: 200,
    indexable: "Yes",
  ...
  {
    id: "u8",
    url: "https://www.busbud.com/en/about/careers",
    title: "Careers at Busbud",
    pageType: "Support",
    status: 404,
    indexable: "No",
    depth: 1,
  ...
  {
    id: "u9",
    url: "https://www.busbud.com/en/about/refund-policy",
    title: "Refund Policy",
    pageType: "Support",
    status: 404,
    indexable: "No",
  ...
  {
    id: "u10",
    url: "https://www.busbud.com/en/stops/victoria-coach-station",
  ...
  {
    id: "u11",
    url: "https://www.busbud.com/en/bus-company/alsa",
    title: "ALSA Bus Tickets",
    pageType: "Operator",
    status: 200,
    indexable: "Yes",
    depth: 3,
  ...
  {
    id: "u12",
    url: "https://www.busbud.com/en/routes/london-paris",
    title: "London to Paris Bus",
    pageType: "Route",
    status: 500,
    indexable: "No",
    depth: 4,
  ...
  {
    id: "u13",
    url: "https://www.busbud.com/en/blog/best-bus-routes-europe",
    title: "Best Bus Routes in Europe",
    pageType: "Blog",
    status: 200,
    indexable: "Yes",
    depth: 5,
  ...
  {
    id: "u14",
    url: "https://www.busbud.com/en/bus-routes/madrid-barcelona",
    title: "Madrid to Barcelona Bus",
    pageType: "Route",
    status: 200,
    indexable: "Yes",
    depth: 2,
  ...
  {
    id: "u15",
    url: "https://www.busbud.com/en/checkout",
    title: "Checkout",
    pageType: "Commerce",
    status: 200,
    indexable: "No",
  ...
  {
    id: "u16",
    url: "https://www.busbud.com/en/sitemap.xml",
    title: "XML Sitemap",
    pageType: "Support",
    status: 200,
    indexable: "No",
...
const PAGE_TYPE_OPTIONS: PageTypeFilter[] = [
  "All",
  "Route",
  "City",
  "Operator",
...
const ISSUE_OPTIONS: IssueFilter[] = [
  "All",
  "None",
  "Canonical",
  "Title",
...
function UrlExplorerRoute() {
  ...
  const filteredRows = useMemo(() => {
    ...
    return URL_ROWS.filter((row) => {
      const matchesSearch =
        !normalized || `${row.url} ${row.title}`.toLowerCase().includes(normalized);
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[10px] font-mono uppercase tracking-wider text-muted-foreground">
                    Project / Run / Inventory
                  </p>
                  <h1 className="mt-1 text-2xl font-bold tracking-tight">URL Explorer</h1>
                  <p className="mt-1 text-sm text-muted-foreground">
                    {run.name} · {formatNumber(run.urlsCrawled)} URLs crawled · {run.lastRun}
                  </p>
                </div>
              </div>
            ...
            <div className="border-b border-border p-4 lg:p-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                <FilterSelect
                  ...
                  onChange={(value) => setPageType(value as PageTypeFilter)}
                />
                <FilterSelect
                  label="Status"
                  value={status}
                ...
                <FilterSelect
                  ...
                  onChange={(value) => setIndexable(value as IndexableFilter)}
                />
                <FilterSelect
                  label="Depth"
                  value={depth}
              ...
              <div className="flex flex-wrap items-center gap-2">
                {SEGMENT_OPTIONS.map((option) => (
                  ...
                  >
                    {option}{" "}
                    {option === "All"
                      ? formatNumber(URL_ROWS.length)
                      : formatNumber(URL_ROWS.filter((row) => row.segment === option).length)}
                  </button>
                ))}
              </div>
                ...
                <TableBody>
                  {filteredRows.map((row) => (
                    <TableRow key={row.id}>
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="max-w-[350px] truncate text-sm font-medium text-primary underline-offset-4 hover:underline"
                            >
                              {row.url}
                            </a>
                      ...
                      <TableCell>
                        <Badge variant="outline">{row.pageType}</Badge>
                      </TableCell>
                      <TableCell>
                        <StatusBadge status={row.status} />
                      </TableCell>
                      <TableCell>
                        <IndexableBadge value={row.indexable} />
                      </TableCell>
                      <TableCell className="text-right font-mono">{row.depth}</TableCell>
                      <TableCell className="text-right font-mono">
                        {formatNumber(row.inlinks)}
                      </TableCell>
                      <TableCell className="text-right font-mono">
  ...
  return (
    <label className="space-y-1.5">
      ...
      <select
        ...
        className="h-9 w-full rounded-md border border-input bg-background px-3 text-sm shadow-sm outline-none transition-colors focus:ring-1 focus:ring-ring"
      >
        {options.map((option) => (
...
function StatusBadge({ status }: { status: CrawlUrl["status"] }) {
  ...
  return (
    <Badge variant={isOk ? "default" : isRedirect ? "secondary" : "destructive"}>{status}</Badge>
  );
}
...
function IndexableBadge({ value }: { value: CrawlUrl["indexable"] }) {
  return (
    <span
      className={`inline-flex items-center gap-1 text-xs font-medium ${value === "Yes" ? "text-primary" : "text-muted-foreground"}`}
    >
      {value === "Yes" ? (
...
function IssueBadge({ issue }: { issue: CrawlUrl["issue"] }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-md border border-border bg-surface px-2 py-1 text-xs font-medium text-foreground">
